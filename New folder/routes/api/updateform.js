...
router.post(
    ...
    async (req, res) => {
      ...
      const {userid,name,fatherName,mobile,email,applicantType,district,areaType,address1,address2,pincode,road_urban_local_body_name,road_ward_no,road_locality,road_cuttingReason,road_category,road_totalcost} = req.body;
      const formFields = {name,fatherName,mobile,email,applicantType,district,areaType,address1,address2,pincode,road_urban_local_body_name,road_ward_no,road_locality,road_cuttingReason,road_category,road_totalcost};
